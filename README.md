...
> **API docs:** once running, open `http://localhost:8000/docs` for the interactive Swagger UI (auto-generated by FastAPI).
> **Authentication:** `APP_AUTH_ENABLED=true` is required in production — the dashboard and all API endpoints are unprotected without it.
